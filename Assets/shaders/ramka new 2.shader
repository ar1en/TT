Shader "Ramka new 2"
	...
	SubShader 
	{
		...
		void surf (Input IN, inout SurfaceOutput o) 
		{
			...
			{				
				o.Emission = lerp(_CurrColor.rgb * pow(alpTex1,_Step) * _Power1, 
				_NxColor.rgb * pow(alpTex1,_Step) * _Power1, _ColorChangeCounter);
			}
			
			if (coordUV.x > 0.8)
			{				
				o.Emission =  lerp(_CurrColor.rgb * pow(alpTex1,_Step2) * _Power2, 
				_NxColor.rgb * pow(alpTex1,_Step2) * _Power2, _ColorChangeCounter);
			}
